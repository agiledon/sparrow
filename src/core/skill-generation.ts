 ...
 * Core workflow skills are installed via cli/agent-skill (kernel Workflow → AgentSkillPackage).
 */
...
import { installAgentSkills } from '../cli/agent-skill/install-agent-skills.js';
import type { CommandContent } from './adapters/types.js';
import { getWorkflowStepBySkillId } from './workflow-schema/index.js';
