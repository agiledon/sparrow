...
**tasks.md 版本**：0.1.0（修订历史至 0.1.4；任务项均已 **[x]**）  
**提交版本**：`c0da40ab806d7929f6c25b1cb93c23bdf2e3b2ae`

| 步骤 | 结果 |
|------|------|
| **A** — badsmells §2.0 | IMPL-GEN-008, IMPL-GEN-009, IMPL-GEN-010, IMPL-GEN-011（4，全部 **已消除**） |
| **B** — tasks 引用 | B-T01→008, B-T02→009, B-T03→011, B-T04→010（4，**1:1**，全部完成） |
| **C** — 新增 | 无 |
| **D** — 孤儿 | 无 |
