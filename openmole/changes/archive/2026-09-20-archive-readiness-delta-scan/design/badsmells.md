...
| DESIGN-DF-001 | 设计缺陷 | 已消除 | 归档语义变更需改多处（DF-02 Shotgun Surgery） |
| DESIGN-EN-001 | 封装 | 已消除 | promote 重载 API（string \| Options）泄漏演进细节（EN-04） |
...
| 0.4.0 | 2026-09-20 | — | B-T04：统一 PromoteOptions；DESIGN-EN-001 → 已消除。 |
| 0.5.0 | 2026-09-20 | — | B-T03：archive-gate.md 契约；DESIGN-DF-001 → 已消除。 |
