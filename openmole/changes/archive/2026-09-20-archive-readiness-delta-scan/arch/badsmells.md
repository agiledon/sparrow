...
| ARCH-BD-001 | 边界性 | 已消除 | archive skill 依赖 core `promoteChangeToMaster`，生成态无 ACL/脚本入口（BD-04） |
| ARCH-EV-001 | 演进性 | 已消除 | 变更 archive 规则需同步改 core + 模板脚本 + skill 文案（EV-02） |
...
| 0.4.0 | 2026-09-20 | — | B-T03：sparrow-promote.mjs 生成脚本 + skill 指向；ARCH-BD-001 → 已消除。 |
| 0.5.0 | 2026-09-20 | — | B-T04：archive-gate.md 单一契约；ARCH-EV-001 → 已消除。 |
